...
var TranslationLink = function TranslationLink(_ref) {
  ...
  var handleClick = React__namespace.useCallback( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(id) {
      var fieldName, _ref5, baseDocumentWOSlug;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _ref5 = baseDocument ? baseDocument : {
                slug: ''
              }, baseDocumentWOSlug = _objectWithoutProperties__default["default"](_ref5, _excluded);
              _context.next = 5;
              return getSanityClient().createIfNotExists(_objectSpread$2(_objectSpread$2({}, baseDocument ? baseDocumentWOSlug : {}), {}, _defineProperty__default["default"]({
