        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              baseDocumentWithoutDontTranslateFields = _objectSpread$2({}, Object.keys(baseDocumentFull).reduce(function (acc, key) {
                if (dontTranslateFields.includes(baseDocumentFull[key].name)) return acc;
                return _objectSpread$2(_objectSpread$2({}, acc), {}, _defineProperty__default["default"]({}, key, baseDocumentFull[key]));
              }, {}));
              _context.next = 6;
