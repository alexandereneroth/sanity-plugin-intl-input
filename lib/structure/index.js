        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              baseDocumentWithoutDontTranslateFields = _objectSpread$2(_objectSpread$2({}, baseDocumentFull), {}, {
                fields: baseDocumentFull.fields.filter(function (field) {
                  return !dontTranslateFields.includes(field.name);
                })
              });
              _context.next = 6;
